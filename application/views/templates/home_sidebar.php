        ...
        <?php if ($_SESSION["status"] == "admin") { ?>
          <li>
            <a href="<?= base_url('mimin'); ?>">
              <i class="fa fa-dashboard"></i> <span class="text-white">Dashboard</span>
        ...
        <?php if ($_SESSION["status"] == "admin") { ?>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?= base_url('data_obat'); ?>"><i class="fa fa-circle-o"></i> Stok Obat</a></li>
              <li><a href="<?= base_url('list_pasien'); ?>"><i class="fa fa-circle-o"></i> Data Pasien</a></li>
              <!-- <li>
