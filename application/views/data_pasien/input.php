  		...
  		<div class="row">
  			<div class="col-xs-12">
  				<div class="box">
  					...
  					<div class="box-body">
  						<form action="<?= base_url('data_pasien/tambah') ?>" method="post">
  							...
  							<div class="form-group row">
  								...
  								<div class="col-sm-10">
  									<input type="text" class="form-control" id="golongan" name="golongan" value="">
  								</div>
  							</div>
  							<div class="form-group row">
  								<label for="umur" class="col-sm-2 col-form-label">Umur</label>
  								<div class="col-sm-10">
  									<input type="text" class="form-control" id="umur" name="umur" value="">
  								</div>
  							</div>
  							<div class="">
